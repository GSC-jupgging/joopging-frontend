      ...
      backgroundColor: BG_COLOR,
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            double distanceValue = ((userData)['distance'] ?? 0.0).toDouble();
            return Center(
              child: Column(
                children: [
                  SizedBox(height: 60,),
                  ...
                  ProfileList(
                      child: createRows3(
                          "총 뛴 거리:",
                          distanceValue >= 1000 ? (distanceValue / 1000).toStringAsFixed(2) : distanceValue.toInt().toString(),
                          distanceValue >= 1000 ? "km" : "m"
                      )
                  ),
                  ProfileList(
                      child: createRows3(
...
Row createRows3 (String title, dynamic count, String units){
  return Row(
